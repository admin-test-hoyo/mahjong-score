...
final historyProvider = FutureProvider.autoChangeNotifier((ref) => HistoryNotifier());
...
class HistoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: history.when(
        data: (notifier) {
          if (notifier.loading) return const Center(child: CircularProgressIndicator(color: Color(0xFF00FFC2)));
          if (notifier.games.isEmpty) return Center(child: Text('履歴がありません', style: TextStyle(color: Colors.white24)));
