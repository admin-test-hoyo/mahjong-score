      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text('Ver 2.3.1', style: GoogleFonts.notoSansJp(color: Colors.white24, fontSize: 10, fontWeight: FontWeight.bold)),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text('Ver 2.3.1', style: GoogleFonts.notoSansJp(color: Colors.white12, fontSize: 9)),
        ],
      ),
    );
  }
