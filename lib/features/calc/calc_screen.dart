      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              const Text('Ver 3.5.2', style: TextStyle(color: Colors.white24, fontSize: 10, fontWeight: FontWeight.bold)),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          const Text('Ver 3.5.2', style: TextStyle(color: Colors.white12, fontSize: 9)),
        ],
      ),
    );
  }
