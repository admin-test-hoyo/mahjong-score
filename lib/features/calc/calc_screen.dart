...
import '../member/member_selection_screen.dart';
...
class CalcScreen extends ConsumerWidget {
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text('Ver 2.3.0', style: GoogleFonts.notoSansJp(color: Colors.white24, fontSize: 10, fontWeight: FontWeight.bold)),
  ...
  static void _showMemberPicker(BuildContext context, WidgetRef ref) {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => MemberSelectionScreen(initialGroupId: state.pickedGroupId),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text('Ver 2.3.0', style: GoogleFonts.notoSansJp(color: Colors.white12, fontSize: 9)),
        ],
      ),
    );
  }
  ...
  Widget _buildSumBlock(String name, Map<String, int> data, AppConfig conf, int players, int count, [int? snap]) {
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text('場代込：¥${balance.toInt().toCommaString()}', style: GoogleFonts.notoSansJp(color: balance < 0 ? Colors.redAccent : const Color(0xFF00FFC2), fontSize: 13, fontWeight: FontWeight.bold)),
    ]);
  }
...
// Ver 2.2.1: _MemberPickerModal was removed in favor of MemberSelectionScreen
